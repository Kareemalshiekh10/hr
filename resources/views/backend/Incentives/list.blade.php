                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="{{ old('id') }}" name="id" class="form-control"  placeholder="Enter Incentive ID"> 
                        </div>  
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <a href="{{ url('admin/Incentives') }}" class="btn btn-success"
                        ...
                        @forelse($getRecord as $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/Incentives/delete/'.$value->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                                    <a href="{{ url('admin/Incentives/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
