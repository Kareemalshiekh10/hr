                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label>Annual Holiday ID</label>
                            <input type="text" value="{{ old('id') }}" name="id" class="form-control"  placeholder="Enter Annual Holiday ID"> 
                        </div>  
                        <div class="form-group col-md-3">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <a href="{{ url('admin/AnnualHolidays') }}" class="btn btn-success"
                        ...
                        @forelse($getRecord as $value)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/AnnualHolidays/delete/'.$value->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                                    <a href="{{ url('admin/AnnualHolidays/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
