...
@section('content')
    ...
    <div style="background-color: #cecece" class="content-wrapper">
        ...
        <section style="margin-left: -200px" class="content">
            <form class="form" method="post" action="{{ url('admin/OfficialHolidays/add') }}" enctype="multipart/form-data">
                @csrf
                ...
                <input type="submit" value="Add Official Holiday" class="btn btn-primary">
            </form>
        </section>
