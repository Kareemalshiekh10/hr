...
@section('content')
    ...
    <div style="background-color: #cecece" class="content-wrapper">
        ...
        <section style="margin-left: -200px" class="content">
            <form class="form-horizontal" method="post" action="{{ url('admin/AnnualIncreases/edit/' . $getRecord->id) }}"
                enctype="multipart/form-data">
                {{ csrf_field() }}
                <h2>Edit Annual Increases</h2>
                <div class="row gy-1 h-100">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" value="{{ $getRecord->percentage_inc }}" name="percentage_inc" class="form-control" required>
                    </div>

                    <div class="col-6">
                        <label class="form-label">Effective Date</label>
                        <input type="date" value="{{ $getRecord->effective_date }}" name="effective_date" class="form-control" required>
                    </div>
