...
<head>
  ...
  <link rel="stylesheet" href="{{ url('public/backend/dist/css/Sidebar.css')}}">
  <link rel="stylesheet" href="{{ url('public/backend/dist/css/Employees.css')}}">
  <link rel="stylesheet" href="{{ url('public/backend/dist/css/Add&Edit_Pages.css')}}">
...
<script src="{{ url('public/backend/dist/js/pages/Employees.js')}}"></script>
